...
const (
	AuthService_Login_FullMethodName    = "/sso_v1.AuthService/Login"
	AuthService_Register_FullMethodName = "/sso_v1.AuthService/Register"
	AuthService_Refresh_FullMethodName  = "/sso_v1.AuthService/Refresh"
	AuthService_Logout_FullMethodName   = "/sso_v1.AuthService/Logout"
)
...
func (c *authServiceClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginResponse)
...
func (UnimplementedAuthServiceServer) Logout(context.Context, *LogoutRequest) (*LoginResponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sso_v1.AuthService",
